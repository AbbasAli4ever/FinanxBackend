...
export class QueryBillsDto {
  @IsOptional()
  @IsEnum(['DRAFT', 'RECEIVED', 'PARTIALLY_PAID', 'PAID', 'OVERDUE', 'VOID'], {
    message: 'Status must be one of: DRAFT, RECEIVED, PARTIALLY_PAID, PAID, OVERDUE, VOID',
  })
  status?: string;
  ...
  @IsOptional()
  @IsEnum(['billNumber', 'billDate', 'dueDate', 'totalAmount', 'amountDue', 'status', 'createdAt'], {
    message: 'Sort by must be one of: billNumber, billDate, dueDate, totalAmount, amountDue, status, createdAt',
  })
  sortBy?: string;
