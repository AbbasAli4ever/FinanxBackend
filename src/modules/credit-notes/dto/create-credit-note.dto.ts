...
export class CreateCreditNoteLineItemDto {
  @IsOptional()
...
export class CreateCreditNoteDto {
  ...
  @IsOptional()
  @IsString({ message: 'Credit note number must be a text value' })
  @MaxLength(50, { message: 'Credit note number cannot exceed 50 characters' })
